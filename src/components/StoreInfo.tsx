...
const StoreInfo = ({ name, description, city, address }: IProps) => {
  return (
    <div className="flex flex-col mt-4 lg:mt-0 w-full lg:w-auto justify-center">
      ...
      <p className=" w-full lg:w-[550px] font-poppins text-[15px] leading-[24px]  lg:leading-[27px]">
        {description}
      </p>
      <div className="w-[262px] my-4 bg-[#CCCCCC] h-[1px]"></div>
      <div className="flex items-center lg:justify-center">
        <i className="ri-map-pin-2-fill mr-1 text-[16px] lg:text-[18px] text-bd-blue"></i>
        <span className="lg:w-[550px] font-poppins text-[14px] lg:text-[16px]  leading-[27px]">
          {`${address}  ${city}`}
        </span>
      </div>
    </div>
