...
function Properties({ title, content, icon, bg, overlay }: IProps) {
  return (
    <div className="flex md:mr-6 items-center  md:w-[446px]  md:items-start  flex-col card">
      <div
      ...
      <span className="text-[#4e4d4d] text-center md:text-left pr-2 font-poppins text-[17px] leading-[26px]">
        {content}
      </span>
    </div>
  )
